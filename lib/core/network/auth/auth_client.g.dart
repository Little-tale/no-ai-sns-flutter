...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<LoginResponseDTO> login(Map<String, String> credentials) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<CheckNicknameResponseDTO> checkNickname(String nickname) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'nickname': nickname};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CheckNicknameResponseDTO>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CheckNicknameResponseDTO _value;
    try {
      _value = CheckNicknameResponseDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<MeDTO> getMe() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MeDTO>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/me',
    ...
    late MeDTO _value;
    try {
      _value = MeDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
