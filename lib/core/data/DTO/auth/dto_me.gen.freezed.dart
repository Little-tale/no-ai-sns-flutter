...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,nickname,profileImagePath,profileImagePendingPath,profileAiStatus,profileAiLabel,profileAiScore,createdAt,followerCount,followingCount,isMe);

@override
String toString() {
  return 'MeDTO(id: $id, email: $email, nickname: $nickname, profileImagePath: $profileImagePath, profileImagePendingPath: $profileImagePendingPath, profileAiStatus: $profileAiStatus, profileAiLabel: $profileAiLabel, profileAiScore: $profileAiScore, createdAt: $createdAt, followerCount: $followerCount, followingCount: $followingCount, isMe: $isMe)';
}
...
@useResult
$Res call({
 int id, String email, String nickname,@JsonKey(name: 'profile_image_path') String? profileImagePath,@JsonKey(name: 'profile_image_pending_path') String? profileImagePendingPath,@JsonKey(name: 'profile_ai_status') String? profileAiStatus,@JsonKey(name: 'profile_ai_label') String? profileAiLabel,@JsonKey(name: 'profile_ai_score') int? profileAiScore,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'follower_count') int followerCount,@JsonKey(name: 'following_count') int followingCount,@JsonKey(name: 'is_me') bool isMe
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String email,  String nickname, @JsonKey(name: 'profile_image_path')  String? profileImagePath, @JsonKey(name: 'profile_image_pending_path')  String? profileImagePendingPath, @JsonKey(name: 'profile_ai_status')  String? profileAiStatus, @JsonKey(name: 'profile_ai_label')  String? profileAiLabel, @JsonKey(name: 'profile_ai_score')  int? profileAiScore, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'follower_count')  int followerCount, @JsonKey(name: 'following_count')  int followingCount, @JsonKey(name: 'is_me')  bool isMe)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MeDTO() when $default != null:
return $default(_that.id,_that.email,_that.nickname,_that.profileImagePath,_that.profileImagePendingPath,_that.profileAiStatus,_that.profileAiLabel,_that.profileAiScore,_that.createdAt,_that.followerCount,_that.followingCount,_that.isMe);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String email,  String nickname, @JsonKey(name: 'profile_image_path')  String? profileImagePath, @JsonKey(name: 'profile_image_pending_path')  String? profileImagePendingPath, @JsonKey(name: 'profile_ai_status')  String? profileAiStatus, @JsonKey(name: 'profile_ai_label')  String? profileAiLabel, @JsonKey(name: 'profile_ai_score')  int? profileAiScore, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'follower_count')  int followerCount, @JsonKey(name: 'following_count')  int followingCount, @JsonKey(name: 'is_me')  bool isMe)  $default,) {final _that = this;
switch (_that) {
case _MeDTO():
return $default(_that.id,_that.email,_that.nickname,_that.profileImagePath,_that.profileImagePendingPath,_that.profileAiStatus,_that.profileAiLabel,_that.profileAiScore,_that.createdAt,_that.followerCount,_that.followingCount,_that.isMe);}
}
